...
class FinalPerfectedAdvancedKeyEnablingExtractor:
    """Final perfected Advanced Key & Enabling format extractor"""
    ...
    def __init__(self):
        ...
        # Quality thresholds optimized for Advanced Key & Enabling format
        self.thresholds = {
            'min_content_length': 1000,  # Higher threshold for advanced format
            'max_contamination': 0.15,
            'min_confidence': 0.6,
            'excellence_score': 140,
            'min_key_enabling_score': 30
        }
    ...
    def _validate_content(self, processed_content: Dict[str, Any], pdf_path: str) -> Dict[str, Any]:
        ...
        quality_score = (
            ...
            (key_enabling_score / 100.0) * 35 +  # Key & Enabling content (high weight)
...
def main():
    ...
    extractor = FinalPerfectedAdvancedKeyEnablingExtractor()
    results = []
